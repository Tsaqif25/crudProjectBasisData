...
if (isset($_POST['aksi2'])) {
  ...
  if ($_POST['aksi2'] == "tambah2") {
    ...
    if (mysqli_num_rows( $nimMahasiswa1) > 0){
      echo 
          " <script> alert ( 'Nim Already') ; </script> " ;
    }
    $noHP1 = $_POST['noHP1'];
    ...
    if ($sql) {
      ...
      header("Location: 25.penginputan data mahasiswa oleh admin.php");
    }
  } else if ($_POST['aksi2'] == "edit2") {
    $namaMahasiswa1 = $_POST['namaMahasiswa1'];
    $jurusan1 = $_POST['jurusan1'];
    $nimMahasiswa1 = $_POST['nimMahasiswa1'];
    $noHP1 = $_POST['noHP1'];

    $query = "UPDATE mahasiswa1 SET namaMahasiswa1 = '$namaMahasiswa1 ' , jurusan1 = ' $jurusan1'  , nimMahasiswa1 = ' $nimMahasiswa1', noHP1 = '$noHP1 ' where nimMahasiswa1 = '$nimMahasiswa1' ; ";
    $sql = mysqli_query($conn, $query);
