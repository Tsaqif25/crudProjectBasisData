...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <form method="POST" action="24.proses jadwal belajar.php">
         ...
         <div class="form-group ">
            ...
            <div class="form-group">
                ...
                <select required type="text" class="form-control" name ="jam" value = "<?php echo $jam;?>" >
                    <option  <?php if($jam   == '20.15 - 21.45') {echo "selected";}     ?> value = "20.15 - 21.45" >   20.15 - 21.45 </option>
            ...
            <div class="form-group">
                <label   for="idZoomMeeting"> Id Zoom Meeting</label>
            ...
            <a href="22.proses pembayaran paket belajar.php" type="button" class="btn btn-danger">
