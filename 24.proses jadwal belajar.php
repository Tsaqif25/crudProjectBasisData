...
if (isset($_POST['aksi'])) {
  if ($_POST['aksi'] == "tambah") {
    ...
    header("Location: 21.pembelajaran saya.php");
    ...
    if ($sql) {
      ...
      header("Location: 23.penginputan jadwal belajar oleh user.php");
    }
    ...
    $query = " UPDATE jadwalbelajar SET kodeJadwal = '$kodeJadwal' , tanggal = '$tanggal' ,hari = '$hari', jam = '$jam',namaKelas = ' $namaKelas' ,nimMahasiswa1 = '$nimMahasiswa1' , idMentor = '$idMentor' , idZoomMeeting = '$idZoomMeeting '   ;";
