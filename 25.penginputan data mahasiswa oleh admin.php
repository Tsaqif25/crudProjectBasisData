...
$query = mysqli_query($conn, "SELECT * FROM jadwalBelajar WHERE user_gmail = '$gmail'");
$cek = mysqli_num_rows($query);
if($cek > 0){
    echo "<script>
    alert ('anda sudah ada data');
    document.location.href = '21.pembelajaran saya.php';
  </script>";
}else{
...
<html lang="en">
  ...
  <body>
    <div class="container">
        <form method="POST" action="26.proses oleh admin.php">
