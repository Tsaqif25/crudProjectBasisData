...
<div class="col-md-10 p-5 pt-2">
    ...
    <!-- <h1>Hello, world!</h1> -->
     <a href="14.create pembayaran.php" type="button" class="btn btn-primary">Tambah Data</a> 
    <br><br>
    ...
    while ($result = mysqli_fetch_assoc( $sql)){
      ?>
        ...
        <td>  <?php  echo $result["nimMahasiswa1"]; ?></td>
          ...
          <td>
          <img src="fotoTsaqif/<?php echo $result['buktiPembayaran']; ?>" style="width: 100px;">
							</td>
      
          
          <td> <a href= "15.proses pembayaran.php?hapus= <?php echo $result['idTransaksi'];?> "type="button" class=  "btn btn-danger" onClick = "return confirm ('Apakah Anda Ingin Menghapus ?')"  ;?> Hapus</a></td>
          <td> <a href ="14.create pembayaran.php?ubah= <?php echo $result['idTransaksi'];?> "type="button" class= "btn btn-info">Ubah </a></td>  
