...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <form method="POST" action="18.proses.php">
            <input type="hidden" value = "<?php echo $idTransaksi?>" name = "idTransaksi">
        <h2 class="alert alert-success text-center mt-3">Formulir Pembayaran</h2>
            ...
            <div class="form-group ">
                ...
                <input required type="text" name="tanggalTransaksi" class="form-control" placeholder="Masukkan Biaya" id="biaya" value = "<?php echo $tanggalTransaksi;?>" >
            </div>
          
            <div class="form-group ">
                <label for="buktiPembayaran">Bukti Pembayaran</label>
                <input required type="text" name="buktiPembayaran" class="form-control" placeholder="Masukkan Bukti Pembayaran" id="biaya" value = "<?php echo $buktiPembayaran;?>" >
            </div>
              ...
              <div class="col"> 
                <?php
                    if(isset($_GET['ubah'])){
                ?>
                <button  require type="submit" name="aksi1" value="edit" class="btn btn-primary">
            ...
            <a href="17.pembayaran.php" type="button" class="btn btn-danger">
